      ...
      <div className="container py-24 lg:py-32">
        ...
        <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
          ...
          <p className="mt-1 text-muted-foreground">
            Siapapun kamu, dapatkan akses ke berbagai fitur unggulan ArsiVerse.
          </p>
        </div>
        {/* End Title */}
        {/* Switch */}
          ...
          <Label htmlFor="payment-schedule" className="relative ms-3">
            ...
            <span className="absolute -top-10 start-auto -end-28">
              <span className="flex items-center">
                ...
                <Badge className="mt-3 uppercase">Diskon 40%</Badge>
              </span>
            </span>
          </Label>
        </div>
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
            ...
            <CardContent>
              <ul className="mt-7 space-y-2.5 text-sm">
                <li className="flex space-x-2">
                  ...
                  <span className="text-muted-foreground">Upload portofolio</span>
                </li>
                <li className="flex space-x-2">
                  <CheckIcon className="flex-shrink-0 mt-0.5 h-4 w-4" />
                  <span className="text-muted-foreground">Gabung komunitas</span>
                </li>
                <li className="flex space-x-2">
                  <CheckIcon className="flex-shrink-0 mt-0.5 h-4 w-4" />
                  <span className="text-muted-foreground">Apply ke proyek</span>
                </li>
              </ul>
            </CardContent>
            <CardFooter>
          ...
          <Card className="border-primary">
            <CardHeader className="text-center pb-2">
              ...
              <CardTitle className="!mb-7">Freelancer</CardTitle>
          ...
          <Card>
            <CardHeader className="text-center pb-2">
              <CardTitle className="mb-7">Profesional</CardTitle>
